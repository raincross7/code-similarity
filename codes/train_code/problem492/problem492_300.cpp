...
int main() {
    ...
    ll additionalLeftCount = 0, additionalRightCount = 0;
    for (ll i = 0; i < N; i++) {
        if (s[i] == left) {
            leftCount++;
        }
    ...
    for (ll i = N - 1; i >= 0; i--) {
        if (s[i] == right) {
            ...
            if (rightCount > 0) {
                ...
                additionalRightCount++;
            }
        }
    }

    string leftString = "";
    for (ll i = 0; i < additionalLeftCount; i++) {
        leftString += left;
    }

    string rightString = "";
    for (ll i = 0; i < additionalRightCount; i++) {
        rightString += right;
    }
    
    cout << leftString + s + rightString << endl;
