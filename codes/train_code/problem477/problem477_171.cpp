...
// Problem: Anti-Division
// Contest: Virtual Judge - AtCoder
// URL: https://vjudge.net/problem/AtCoder-abc131_c
...
LL cal(LL x,LL c,LL d){
  return x-(x/c+x/d-x/((LL)(c*d/__gcd(c,d))));
}

void Solve(){
  LL a,b,c,d;
  cin>>a>>b>>c>>d;
  cout<<cal(b,c,d)-cal(a-1,c,d)<<endl;
} 
