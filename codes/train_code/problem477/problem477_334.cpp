...
int main() {
	...
	long long tot = b - a + 1;
	long long c_mult = (b / c) - ((a - 1) / c);
	long long d_mult = (b / d) - ((a - 1) / d);
	long long cd_mult = (b / lcm(c , d)) - ((a - 1) / lcm(c , d));

	long long c_or_d_mult = c_mult + d_mult - cd_mult;

	long long c_nor_d_mult = tot - c_or_d_mult;
