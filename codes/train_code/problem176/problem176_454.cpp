...
int main() {
  ...
  for(int i=0; i<1000; i++){
    ...
    for(int j=0; j<n; j++){
      ...
      if(flagA == 1 && flagB == 1 && s.at(j)-'0' == i%10){
        flagC = 1;
        break;
      }      
      
      if(flagA == 1 && s.at(j)-'0' == (i%100)/10){
        flagB = 1;
      }
...
/*
      if(flagA == 0 && flagB == 0 && flagC == 0 && s.at(j)-'0' == i / 100){
        flagA = 1;
      }
      else if(flagA == 1 && flagB == 0 && flagC == 0 && s.at(j)-'0' == (i%100)/10){
        flagB = 1;
//        cout << i << endl;
      }
      else if(flagA == 1 && flagB == 1 && s.at(j)-'0' == i%10){
        flagC = 1;
        break;
      }
