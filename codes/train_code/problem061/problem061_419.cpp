...
//  cout << one_loop_count << endl;
//  cout << two_loop_count << endl;
   ll shokou = one_loop_count;
   ll kousa  = two_loop_count - one_loop_count;
   if(k==1) cout << shokou << endl;
   else     cout << shokou + kousa*(k-1) << endl;
   return 0;
 }//else end
//     cout << b.at(i);
}