...
int main(){
    ...
    if(X > 0 && Y > 0){
        ...
        if(abs(X) > abs(Y))cout << abs(X) - abs(Y) + 1 << endl;
        else if(abs(Y) > abs(X))cout << abs(Y) - abs(X) + 1 << endl;
        else{
            cout << 1 << endl;
        }
    }
