...
ll fact[1000009]={0};
void facto() {fact[0]=1LL;fact[1]=1LL;for(int i=2;i<=1000008;i++)fact[i]=(fact[i-1]*i)%mod;}
ll ncr(ll n,ll r) {ll res=1LL; res=fact[n]; res=(res*(power(fact[r],mod-2)))%mod; res=(res*(power(fact[n-r],mod-2)))%mod; return res%mod;}
