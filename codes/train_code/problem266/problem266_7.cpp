...
/*nCr*/ll ncr(ll n,ll r){ll ans=1,l=2;rep(i,0,min(n-r,r)){ans*=(n-i);while(ans%l==0&&l<=min(r,n-r)){ans/=l;l++;}}return ans;}
/*nPr*/ll npr(ll n,ll r){ll ans=1;rep(i,0,r)ans*=(n-i);return ans;}
...
// pnn;cout<<cnt[0]<<" "<<cnt[1]<<" "<<tmp<<" "<<ans<<endl;
 ans*=tmp;
 pr(ans);
return 0;}
