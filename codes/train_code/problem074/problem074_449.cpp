...
int main() {
  ...
  if(a ==1 || b==1 || c ==1 || d ==1) iticount++;
  if(a ==4 || b==4 || c ==4 || d ==4) yoncount++;
  if(a ==7 || b==7 || c ==7 || d ==7) nanacount++;
  if(a ==9 || b==9 || c ==9 || d ==9) kyucount++;
  
  if(iticount == 1 && yoncount == 1 && nanacount == 1 && kyucount == 1) cout<<"YES"<<endl;
  else cout << "NO"<<endl;
