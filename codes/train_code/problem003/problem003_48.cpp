...
int main(void)
{
	...
	if (400 <= X && X < 600) output(8);
	else if (600 <= X && X < 800) output(7);
	else if (800 <= X && X < 1000) output(6);
	else if (1000 <= X && X < 1200) output(5);
	else if (1200 <= X && X < 1400) output(4);
	else if (1400 <= X && X < 1600) output(3);
	else if (1600 <= X && X < 1800) output(2);
	else if (1800 <= X && X < 2000) output(1);
	return 0;
}
