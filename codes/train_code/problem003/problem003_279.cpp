...
void solve()
{
    /// code is here->
    v99 n;cin>>n;
    if(n>=400 && n<=599)cout<<8<<ses;
    else if(600<=n && n<=799)cout<<7<<ses;
    else if(800<=n && n<=999)cout<<6<<ses;
    else if(1000<=n && n<=1199)cout<<5<<ses;
    else if(1200<=n && n<=1399)cout<<4<<ses;
    else if(1400<=n && n<=1599)cout<<3<<ses;
    else if(1600<=n && n<=1799)cout<<2<<ses;
    else if(1700<=n && n<=1999)cout<<1<<ses;
    else cout<<7<<ses;
}
