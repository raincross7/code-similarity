...
int clue() {
    ...
    elif(x>=1600){cout<<2<<endl;}
    elif(x>=1400){cout<<3<<endl;}
    elif(x>=1200){cout<<4<<endl;}
    elif(x>=1000){cout<<5<<endl;}
    elif(x>=800){cout<<6<<endl;}
    elif(x>=600){cout<<7<<endl;}
    elif(x>=400){cout<<8<<endl;}
    return 0;
}