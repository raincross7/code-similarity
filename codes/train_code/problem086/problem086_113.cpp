...
int main(int argc, char** argv) {
  ...
  // diff: 1 -6  3 -7  3
  //
  // To reduce 1 from plus-diff, 2 is needed to add to a negtive-diff:
  //     1 -6 3 -7 3
  //  -> 0 -4 3 -7 3
  //  -> 0  0 1 -7 3
  //  -> 0  0 0 -5 3
  // => negative-diff is not enuogh to reduce plus-diff, the answer is No.
  ll n;
  cin >> n;
  ll a[n];
  fi(0, n)
