...
/*
	...
	※bit全探索を使用しなくてもよい
	必ず opに＋か－が入る為
	なので、bit全探索にヒットした場合を+として、他は－とすればよい
	n=3 としているのは opの数が3固定である為、ここは固定でよい
	1 << 3 までのパターンで"+"がどこでとられるかを検知で処理している
*/
