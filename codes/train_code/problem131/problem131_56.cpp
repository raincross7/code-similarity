...
void solve() {
    ...
    if(d) {
        cout << fixed << setprecision(10) << (long double)(n - d) * 2.0L * (long double)(m - 1) / (long double)(n * n) << en;
    } else {
        cout << fixed << setprecision(10) << (long double)(n - d) * (long double)(m - 1) / (long double)(n * n) << en;
    }
}
