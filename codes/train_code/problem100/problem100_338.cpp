...
int main()
{
    ...
    if((b[a[0][0]] && b[a[0][1]] && b[a[0][2]]) || (b[a[1][0]] && b[a[1][1]] && b[a[1][2]]) || (b[a[2][0]] && b[a[2][1]] && b[a[2][2]]))
        result++;
    if((b[a[0][0]] && b[a[1][0]] && b[a[2][0]]) || (b[a[0][1]] && b[a[1][1]] && b[a[2][1]]) || (b[a[0][2]] && b[a[1][2]] && b[a[2][2]]))
        result++;
    if((b[a[0][0]] && b[a[1][1]] && b[a[2][2]]) || (b[a[0][2]] && b[a[1][1]] && b[a[2][0]]))
        result++;
    if(result)
        cout << "Yes" << endl;
    else
