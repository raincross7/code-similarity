...
int main() {
    ...
    vector<vector<llu>> vh(N,vector<llu>(N,0)); // vertical hash
    vector<vector<llu>> hh(N,vector<llu>(N,0)); // horizontal hash
    vector<vector<llu>>vhh(N,vector<llu>(N,0)); // vertical hash hash
    vector<vector<llu>>hhh(N,vector<llu>(N,0)); // horizontal hash hash
