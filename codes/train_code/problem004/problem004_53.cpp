...
ll RPS(ll id, char b, char a){
    if(T[id] == 'r'){
        if(b == 'p'){
            H.push_back(optimize('p', a));
            return 0;
        }else{
            H.push_back('p');
            return P;
