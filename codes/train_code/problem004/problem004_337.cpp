...
int calc(char* game, int n, int k, int rock, int paper, int scissors)
{
	static int skip[100001];
	zeroi(skip, n);
	int sum = 0;
	repi(n)
	{
...
int main()
{
	...
	int scissors = readi();
	int paper = readi();
	static char game[100001];
	reads(game, 100001);

	int sum = calc(game, n, k, rock, paper, scissors);
