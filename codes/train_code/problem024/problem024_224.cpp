...
//    printf("path l col idx[%d] col ofs [%d], cycle[%d] num[%d]\n", 
//            dwPathLColIdx, dwPathLColOfs, sqCycle, s_dwPathNum_L);
//    printf("col num [%d]\n", sqPathColNum);
...
//    printf("ants idx on path 0 [%d]\n", dwAntsIdxOnPathR0);
//    printf("path 0 last pos [%d]\n", dwPath0LastPos);
