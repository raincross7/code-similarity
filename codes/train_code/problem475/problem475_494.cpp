...
int main(){
    ...
    auto cmp = [](auto i, auto j){return atan2(static_cast<long double>(i.first), static_cast<long double>(i.second)) < atan2(static_cast<long double>(j.first), static_cast<long double>(j.second));};
