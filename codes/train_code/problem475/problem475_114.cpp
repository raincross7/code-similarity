...
int main(){
    ...
    boost::multiprecision::cpp_dec_float_100 t(ans), l(10), k(boost::multiprecision::floor(boost::multiprecision::sqrt(t) * boost::multiprecision::pow(l, 48)) * boost::multiprecision::pow(l, -48));
    cout << k.str(48, std::ios_base::fixed) << endl;
    return 0;
}