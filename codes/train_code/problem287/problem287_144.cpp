...
int main(){
  ...
  int num = n/2;
  if(max_a_num == max_b_num){
    if(max_a > max_b){
      cout << (num - max_a) + (num - sec_b) <<endl;
      return 0;
    }
    else if(max_a < max_b){
      cout << (num - sec_a) + (num - max_b) <<endl;
      return 0;
    }
    else{
      if(sec_a > sec_b){
