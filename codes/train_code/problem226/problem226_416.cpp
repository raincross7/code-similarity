...
int main(){
  ...
  cin >> str1;
  if(str1=="Vacant")return 0;
  cout << n-1<< '\n' ;
  cin >> str2;
  if(str2=="Vacant")return 0;
  rep0(i,20){
    cout << (r+l+1)/2<< '\n';
    cin >> str;
    if(str=="Vacant")return 0;
    else if(str!=str1 && ((r+l+1)/2-l)%2==0 || str==str1 && ((r+l+1)/2-l)%2==1){
      r=(r+l+1)/2;
      str2=str;
    }
    else if(str!=str2 && (r-(r+l+1)/2)%2==0 || str==str2 && (r-(r+l+1)/2)%2==1){
      l=(r+l+1)/2;
      str1=str;
    }
  }
