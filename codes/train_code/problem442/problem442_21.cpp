...
int main()
{
        ...
        while(t--)
        {
           ...
           maxx=LLONG_MIN;
           vector <ll> v,v1,v3,v4,v5,v6;
           vector < pair <string,ll> > v7;
           string str,str1,str2;
           set <ll> s,s1;
           map <ll,ll> ss;
           vector <string> v8,v9;
           vector < pair <ll,ll> > v10;
           map <ll,ll> mapp,mapp1;
           ll curr=0,curr1=0;
           cin>>str;
           a=0;
           loop(str.size())
           {
               if(str.substr(i,7)=="dreamer")
               {
                   i=i+5;
                   if(str.substr(i,6)=="eraser")
                   {
                       i=i+5;
                       continue;
                   }
                   else if(str.substr(i,5)=="erase")
                   {
                       i=i+4;
                       continue;
                   }
