...
void solve(string s) {
  ...
  int n = sz(s);
  rep(i, n - 5) {
    if(s.substr(i, 11) == "dreameraser") i += 10;
    else if(s.substr(i, 10) == "dreamerase") i += 9;
    else if(s.substr(i, 7) == "dreamer") i += 6;
    else if(s.substr(i, 5) == "dream") i += 4;
    else if(s.substr(i, 6) == "eraser") i += 5;
    else if(s.substr(i, 5) == "erase") i += 4;
    else {
      COUT(NO);
      return;
    }
